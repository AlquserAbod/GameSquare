...
const CreateRoom = ({ setPage }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full mb-5 mt-5  flex-wrap"> 
        ...
        <div className="flex justify-between items-center w-full max-sm:justify-start max-sm:flex-col">
            ...
            <div className="game-select w-1/2 max-md:w-full pr-5 pl-5 max-sm:mt-20 flex justify-center flex-col items-center">
                <span className="mb-3"> Select a game</span>
                    <select className="select select-bordered select-lg w-full max-w-xs" onChange={setGame} defaultValue={0}>
                        <option value="0">Tic Tac Toe</option>
                        <option value="1" disabled>chess (Coming Soon) </option>
                    </select>
                </div>
            </div>
                            
        <div className="flex w-1/2 mt-20 max-md:items-center max-md:w-full pr-5 pl-5">
